...
function updateStats() {
    ...
    $("#timeForAns").html("Time per Answer : " + (jData[currUSER].rightAns + jData[currUSER].wrongAns) / jData[currUSER].totalTime);
   ...
   // get the data from user.json file
    ...
    if (localStorage.getItem('active') == null) {
        ...
        if((jData[currUSER].rightAns + jData[currUSER].wrongAns) > 0){
            $("#timeForAns").html("Time per Answer : " +  (jData[currUSER].totalTime/60)/(jData[currUSER].rightAns + jData[currUSER].wrongAns) + " Seconds");
        }
        else
